      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">Développeur Web Full Stack</p>
            <p className="text-gray-400 mb-4">Basé à Votre Ville, Pays</p>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="bg-gray-800 hover:bg-indigo-600 text-white p-3 rounded-full transition duration-300"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
